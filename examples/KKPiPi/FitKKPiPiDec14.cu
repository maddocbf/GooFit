...
// p4-> K-
  ...
  SFKstarKstarS.push_back( new SpinFactor("SF", SF_4Body::DtoV1V2_V1toP1P2_V2toP3P4_S, 1,2,0,3));  


  std::vector<SpinFactor*> SFKstarKstarP;
  SFKstarKstarP.push_back( new SpinFactor("SF", SF_4Body::DtoV1V2_V1toP1P2_V2toP3P4_P, 1,2,0,3));  


  std::vector<SpinFactor*> SFKstarKstarD;
  SFKstarKstarD.push_back( new SpinFactor("SF", SF_4Body::DtoV1V2_V1toP1P2_V2toP3P4_D, 1,2,0,3));  
  ...
  SFPhiFZero.push_back( new SpinFactor("SF", SF_4Body::DtoV1V2_V1toP1P2_V2toP3P4_S, 2,3,0,1)); 
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSK1P2Kstar.push_back( new Lineshape("K1(1270)+", K11270M, K11270W, 1, M_23_1, LS::SBW) );    
  LSK1P2Kstar.push_back( new Lineshape("Kstar(1430)", Kstar892M, Kstar892W, 1, M_23, LS::BW) ); 

  std::vector<Lineshape*> LSK1M2Kstar; 
  LSK1M2Kstar.push_back( new Lineshape("K1(1270)-", K11270M, K11270W, 1, M_14_2, LS::SBW) ); 
  LSK1M2Kstar.push_back( new Lineshape("Kstar(1430)", Kstar892M, Kstar892W,1, M_14, LS::BW) );  

  std::vector<Lineshape*> LSK1P2Rho;
  LSK1P2Rho.push_back( new Lineshape("K1(1270)+", K11270M, K11270W, 1, M_12_3, LS::SBW) );
  LSK1P2Rho.push_back( new Lineshape("Rho ", RhoMass, RhoWidth, 1, M_12, LS::BW) );   

  std::vector<Lineshape*> LSK1M2Rho; 
  LSK1M2Rho.push_back( new Lineshape("K1(1270)-", K11270M, K11270W, 1, M_12_4, LS::SBW) ); 
  LSK1M2Rho.push_back( new Lineshape("Rho ", RhoMass, RhoWidth, 1, M_12, LS::BW) ); 
 
  std::vector<Lineshape*> LSKstarP2Kstar;
  LSKstarP2Kstar.push_back( new Lineshape("Kstar1410", Kstar1410M, Kstar1410W, 1, M_23_1, LS::BW) ); 
  LSKstarP2Kstar.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW) );  

  std::vector<Lineshape*> LSKstarM2Kstar; 
  LSKstarM2Kstar.push_back( new Lineshape("Kstar1410", Kstar1410M, Kstar1410W, 1, M_14_2, LS::BW) ); 
  LSKstarM2Kstar.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW) ); 
   
  std::vector<Lineshape*> LSKstarKstarbarS; 
  LSKstarKstarbarS.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW) ); 
  LSKstarKstarbarS.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW) ); 
  

  std::vector<Lineshape*> LSKstarKstarbarP; 
  LSKstarKstarbarP.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW) ); 
  LSKstarKstarbarP.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW) ); 
  

  std::vector<Lineshape*> LSKstarKstarbarD; 
  LSKstarKstarbarD.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW) ); 
  LSKstarKstarbarD.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW) ); 
  
  std::vector<Lineshape*> LSPhiRhoS; 
  LSPhiRhoS.push_back( new Lineshape("Phi ", phi1020M, phi1020W, 1, M_34, LS::BW) ); 
  LSPhiRhoS.push_back( new Lineshape("Rho ", RhoMass, RhoWidth, 1, M_12, LS::BW) ); 


  std::vector<Lineshape*> LSPhiRhoP; 
  LSPhiRhoP.push_back( new Lineshape("Phi ", phi1020M, phi1020W, 1, M_34, LS::BW) ); 
  LSPhiRhoP.push_back( new Lineshape("Rho ", RhoMass, RhoWidth, 1, M_12, LS::BW) ); 


  std::vector<Lineshape*> LSPhiRhoD; 
  LSPhiRhoD.push_back( new Lineshape("Phi ", phi1020M, phi1020W, 1, M_34, LS::BW) ); 
  LSPhiRhoD.push_back( new Lineshape("Rho ", RhoMass, RhoWidth, 1, M_12, LS::BW)  ); 

  std::vector<Lineshape*> LSPhiFZero; 
  LSPhiFZero.push_back( new Lineshape("Phi ", phi1020M, phi1020W, 1, M_34, LS::Bugg) ); 
  LSPhiFZero.push_back( new Lineshape("FZero ", FZeroMass, FZeroWidth, 1, M_12, LS::Bugg) ); 
