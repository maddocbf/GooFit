...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
 Amplitude* AMP_K1P2Kstar       = new Amplitude( "K1P2Kstar",   new Variable("K1P2Kstar_real", 0.734982),     new Variable("K1P2Kstar_imag", -1.06850  ), LSK1P2Kstar, SFK1P2Kstar, 1);

  Amplitude* AMP_K1M2Kstar       = new Amplitude( "K1M2Kstar",   new Variable("K1M2Kstar_real",-0.00671741),   new Variable("K1M2Kstar_imag",0.3787176 ), LSK1M2Kstar, SFK1M2Kstar , 1);

  Amplitude* AMP_K1P2Rho       = new Amplitude( "K1P2Rho",   new Variable("K1P2Rho_real", -0.146403 ), new Variable("K1P2Rho_imag", 0.354732 ), LSK1P2Rho, SFK1P2Rho, 1);

  Amplitude* AMP_K1M2Rho      = new Amplitude( "K1M2Rho",    new Variable("K1M2Rho_real", -0.17047),  new Variable("K1M2Rho_imag", 0.392414  ), LSK1M2Rho, SFK1M2Rho, 1);
 
 Amplitude* AMP_KstarP2Kstar         = new Amplitude( "KstarP2Kstar",      new Variable("KstarP2Kstar_real", 1.41346),  new Variable("KstarP2Kstar_imag", 0.960341 ), LSKstarP2Kstar, SFKstarP2Kstar, 1);
 
 Amplitude* AMP_KstarM2Kstar     = new Amplitude( "KstarM2Kstar", new Variable("KstarM2Kstar_real", 1.05255),   new Variable("KstarM2Kstar_imag",0.829000 ), LSKstarM2Kstar  , SFKstarM2Kstar , 1);
 
 Amplitude* AMP_KstarKstarbar          = new Amplitude( "KstarKstarbar",      new Variable("KstarKstarbar_real",-7.93891 ),  new Variable("KstarKstarbar_imag", 0.14085  ), LSKstarKstarbar  , SFKstarKstar , 1);
 ...
 Amplitude* AMP_PhiRhoS       = new Amplitude( "PhiRhoS",   new Variable("PhiRhoS_real",   1),  new Variable("PhiRhoS_imag", 0), LSPhiRhoS  , SFPhiRhoS , 1);
  ...
  Amplitude* AMP_PhiRhoD        = new Amplitude( "PhiRhoD",    new Variable("PhiRhoD", 3.01520 ),   new Variable("PhiRhoD_imag", -0.056615  ), LSPhiRhoD  , SFPhiRhoD , 1);
