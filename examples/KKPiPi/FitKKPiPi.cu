...
// p4-> K-
  ...
  SFKstarKstar.push_back( new SpinFactor("SF", SF_4Body::DtoV1V2_V1toP1P2_V2toP3P4_S, 1,2,0,3));  
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSKstarKstarbar.push_back( new Lineshape("Kstar1430", K1430M, K1430W, 0, M_23, LS::BW, FF::BL2) ); 
  LSKstarKstarbar.push_back( new Lineshape("Kstarbar1430", K1430M, K1430W, 0, M_14, LS::BW, FF::BL2) ); 
 ...
 // Amplitude* AMP_K1P2Kstar = new Amplitude("K1(1270)+(Kstar0 pi+)K- ", new Variable("amp_real1", -0.1, 0.001,0,0), new Variable("amp_imag1", 0.1, 0.001, 0,0), LSK1P2Kstar, SFK1P2Kstar, 1);
  ...
  Amplitude* AMP_KstarKstarbar = new Amplitude("KstarKstar ", new Variable("AmpKstarKstarbar_R", -0.1, 0.001,0,0), new Variable("AmpKstarKstarbar_I",  -0.1,0.001, 0,0), LSKstarKstarbar, SFKstarKstar, 1);
 ...
 // Amplitude* AMP_PhiPiPi = new Amplitude("PhiPiPi", new Variable("amp_real10", -0.1, 0.001,0,0), new Variable("amp_imag10", 0.1, 0.001, 0,0), LSPhipipi, SFPhipipi, 1);
  ...
  for (auto res = LSKstarKstarbar.begin(); res != LSKstarKstarbar.end(); ++res) {
    (*res)->setParameterConstantness(true); 
  }
