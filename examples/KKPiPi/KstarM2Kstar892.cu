...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSK1P2Kstar.push_back( new Lineshape("K1(1270)+", K11270M, K11270W, 1, M_23_4, LS::BW, FF::BL2) );    
...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
  Amplitude* AMP_K1P2Kstar       = new Amplitude( "K1P2Kstar",   new Variable("K1P2Kstar_real", -1.36129),     new Variable("K1P2Kstar_imag", 0.0451616  ), LSK1P2Kstar, SFK1P2Kstar, 1);
 ...
 Amplitude* AMP_KstarP2Kstar         = new Amplitude( "KstarP2Kstar",      new Variable("KstarP2Kstar_real", -0.249148 ),  new Variable("KstarP2Kstar_imag", -1.33869  ), LSKstarP2Kstar, SFKstarP2Kstar, 1);
