...
// p4-> K-
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSKstarKstarbarS.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW, FF::BL2) ); 
  LSKstarKstarbarS.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW, FF::BL2) ); 
  

  std::vector<Lineshape*> LSKstarKstarbarP; 
  LSKstarKstarbarP.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW, FF::BL2) ); 
  LSKstarKstarbarP.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW, FF::BL2) ); 
  

  std::vector<Lineshape*> LSKstarKstarbarD; 
  LSKstarKstarbarD.push_back( new Lineshape("Kstar1430", Kstar892M, Kstar892W, 1, M_23, LS::BW, FF::BL2) ); 
  LSKstarKstarbarD.push_back( new Lineshape("Kstarbar1430", Kstar892M, Kstar892W, 1, M_14, LS::BW, FF::BL2) ); 
  ...
  LSPhiFZero.push_back( new Lineshape("FZero ", FZeroMass, FZeroWidth, 1, M_12, LS::BW, FF::BL2) ); 
