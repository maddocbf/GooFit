...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
 ...
 Amplitude* AMP_KstarKstarbarS          = new Amplitude( "KstarKstarbarS",      new Variable("KstarKstarbarS_real",1.0  ),  new Variable("KstarKstarbarS_imag", 0.0), LSKstarKstarbarS  , SFKstarKstarS , 1);
