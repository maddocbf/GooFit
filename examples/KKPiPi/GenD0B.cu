...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
  Amplitude* AMP_K1P2Kstar       = new Amplitude( "K1P2Kstar",   new Variable("K1P2Kstar_real", 0.148996),     new Variable("K1P2Kstar_imag", -0.659614  ), LSK1P2Kstar, SFK1P2Kstar, 1);

  Amplitude* AMP_K1M2Kstar       = new Amplitude( "K1M2Kstar",   new Variable("K1M2Kstar_real", -0.065391),   new Variable("K1M2Kstar_imag", -0.0912521  ), LSK1M2Kstar, SFK1M2Kstar , 1);

  Amplitude* AMP_K1P2Rho       = new Amplitude( "K1P2Rho",   new Variable("K1P2Rho_real", 0.188421 ), new Variable("K1P2Rho_imag", 0.579791  ), LSK1P2Rho, SFK1P2Rho, 1);

  Amplitude* AMP_K1M2Rho      = new Amplitude( "K1M2Rho",    new Variable("K1M2Rho_real", 0.0712315 ),  new Variable("K1M2Rho_imag", 0.326144  ), LSK1M2Rho, SFK1M2Rho, 1);
 
 Amplitude* AMP_KstarP2Kstar         = new Amplitude( "KstarP2Kstar",      new Variable("KstarP2Kstar_real", -1.33137  ),  new Variable("KstarP2Kstar_imag", -0.512567  ), LSKstarP2Kstar, SFKstarP2Kstar, 1);
 
 Amplitude* AMP_KstarM2Kstar     = new Amplitude( "KstarM2Kstar", new Variable("KstarM2Kstar_real", 0.156047  ),   new Variable("KstarM2Kstar_imag",0.326144  ), LSKstarM2Kstar  , SFKstarM2Kstar , 1);
   
 Amplitude* AMP_KstarKstarbarS          = new Amplitude( "KstarKstarbarS",      new Variable("KstarKstarbarS_real", -0.0417826 ),  new Variable("KstarKstarbarS_imag", -0.656577  ), LSKstarKstarbarS  , SFKstarKstarS , 1);
 

 Amplitude* AMP_KstarKstarbarP          = new Amplitude( "KstarKstarbarP",      new Variable("KstarKstarbarP_real", -0.752674 ),  new Variable("KstarKstarbarP_imag", -0.257843  ), LSKstarKstarbarP  , SFKstarKstarP , 1);
 

 Amplitude* AMP_KstarKstarbarD          = new Amplitude( "KstarKstarbarD",      new Variable("KstarKstarbarD_real", 0.795217 ),  new Variable("KstarKstarbarD_imag", -0.986184  ), LSKstarKstarbarD  , SFKstarKstarD , 1);
 ...
 Amplitude* AMP_PhiRhoP       = new Amplitude( "PhiRhoP",   new Variable("PhiRhoP_real", -0.077565  ),  new Variable("PhiRhoP_imag", 0.624425  ), LSPhiRhoP  , SFPhiRhoP , 1);

  Amplitude* AMP_PhiRhoD        = new Amplitude( "PhiRhoD",    new Variable("PhiRhoD", 3.62724  ),   new Variable("PhiRhoD_imag", 0.806439  ), LSPhiRhoD  , SFPhiRhoD , 1);
 
  Amplitude* AMP_PhiFZero        = new Amplitude( "PhiFZero",    new Variable("PhiFZero",-1.06965 ),   new Variable("PhiFZero_imag", 0.402215  ), LSPhiRhoD  , SFPhiRhoD , 1);
