...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSK1P2Kstar.push_back( new Lineshape("Kstar(1430)", K1430M, K1430W, 0, M_23, LS::BW, FF::BL2) ); 

  std::vector<Lineshape*> LSK1M2Kstar; 
  LSK1M2Kstar.push_back( new Lineshape("K1(1270)-", K11270M, K11270W, 1, M_14_2, LS::BW, FF::BL2) ); 
  LSK1M2Kstar.push_back( new Lineshape("Kstar(1430)", K1430M, K1430W,0, M_14, LS::BW, FF::BL2) );  
  ...
  LSKstarKstarbar.push_back( new Lineshape("Kstar", K1430M, K1430W, 0, M_23, LS::BW, FF::BL2) ); 
  LSKstarKstarbar.push_back( new Lineshape("Kstarbar", K1430M, K1430W, 0, M_14, LS::BW, FF::BL2) ); 
...
// the very last parameter means that we have two permutations. so the first half of the Lineshapes 
  ...
  //RS Model
  Amplitude* AMP_K1P2Kstar       = new Amplitude( "K1P2Kstar",   new Variable("K1P2Kstar_real", -2.24101),     new Variable("K1P2Kstar_imag", 1.12147  ), LSK1P2Kstar, SFK1P2Kstar, 1);

  Amplitude* AMP_K1M2Kstar       = new Amplitude( "K1M2Kstar",   new Variable("K1M2Kstar_real",-0.127768 ),   new Variable("K1M2Kstar_imag",0.223673 ), LSK1M2Kstar, SFK1M2Kstar , 1);

  Amplitude* AMP_K1P2Rho       = new Amplitude( "K1P2Rho",   new Variable("K1P2Rho_real", 0.317931  ), new Variable("K1P2Rho_imag",0.344904  ), LSK1P2Rho, SFK1P2Rho, 1);

  Amplitude* AMP_K1M2Rho      = new Amplitude( "K1M2Rho",    new Variable("K1M2Rho_real", -0.254398 ),  new Variable("K1M2Rho_imag",0.249250   ), LSK1M2Rho, SFK1M2Rho, 1);
 
 Amplitude* AMP_KstarP2Kstar         = new Amplitude( "KstarP2Kstar",      new Variable("KstarP2Kstar_real", -1.47342),  new Variable("KstarP2Kstarimag",-1.16162 ), LSKstarP2Kstar, SFKstarP2Kstar, 1);
 
 Amplitude* AMP_KstarM2Kstar     = new Amplitude( "KstarM2Kstar", new Variable("KstarM2Kstar_real", 0.473845 ),   new Variable("KstarM2Kstar_imag", 1.30693 ), LSKstarM2Kstar  , SFKstarM2Kstar , 1);
 
 Amplitude* AMP_KstarKstarbar          = new Amplitude( "KstarKstarbar",      new Variable("KstarKstarbar_real", 10.1219 ),  new Variable("KstarKstarbar_imag", -1.78800  ), LSKstarKstarbar  , SFKstarKstar , 1);
 ...
 Amplitude* AMP_PhiRhoS       = new Amplitude( "PhiRhoS",   new Variable("PhiRhoS_real",   1),  new Variable("PhiRhoS_imag", 0), LSPhiRhoS  , SFPhiRhoS , 1);
  ...
  Amplitude* AMP_PhiRhoD        = new Amplitude( "PhiRhoD",    new Variable("PhiRhoD", 4.95122 ),   new Variable("PhiRhoD_imag",-1.96901 ), LSPhiRhoD  , SFPhiRhoD , 1);
 
 Amplitude* AMP_NonRes1      = new Amplitude( "NonRes1",  new Variable("Nonres1_real", 0.179343),  new Variable("NonRes1_imag",0.134668), LSNonRes1  , SFNonRes1 , 1);
