...
//Load in nTuple and give it to currData/addevent 
  fstream input("DZeroData2.txt", std::ios_base::in);
  ...
  Variable* K1430M   = new Variable("K1430M"   , 1.414  );//not used?
...
// p4-> K-
 ...
 // SFPhipipi.push_back( new SpinFactor("SF", SF_4Body::DtoVP1P2_VtoP3P4, 0,1,2,3)); 
  ...
  LSK1P2Kstar.push_back( new Lineshape("Kstar(1410)", Kstar1410M, Kstar1410W, 1, M_23, LS::BW, FF::BL2) ); 
